...
# ================= 加载模型相关 =========================
# face parsing 模型
faceParsing_ckpt = "{}/face-parsing.PyTorch/79999_iter.pth".format(SHARE_MODELS_ROOT)
...
def faceSwapping_pipeline(source, 
    ...
    if optimize_W:
        ...
        '''
        driven_style_vector = torch.load(os.path.join('{}/pytorch-DDP-demo/work_dirs/v_18_video_swapping/28494_to_874'.format(SHARE_ROOT), "intermediate_results/styleVec/D_style_vec_" + name + '.pt'))
        driven_style_vector = driven_style_vector.cuda()
        target_style_vector = torch.load(os.path.join('{}/pytorch-DDP-demo/work_dirs/v_18_video_swapping/28494_to_874'.format(SHARE_ROOT), "intermediate_results/styleVec/T_style_vec_" + name + '.pt'))
