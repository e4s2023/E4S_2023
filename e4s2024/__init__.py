...
DATASETS_ROOT = os.environ.get("E4S2024_DATASETS_ROOT", "/apdcephfs/share_1290939/zhianliu/datasets")
PRETRAINED_ROOT = os.environ.get("PRETRAINED_ROOT", os.path.join(REPO_ROOT, "pretrained"))
PRETRAINED_SHARE_ROOT = os.environ.get("PRETRAINED_SHARE_ROOT", "/apdcephfs/share_1290939/zhianliu/pretrained_models")
...
__all__ = ["PRETRAINED_ROOT", "DATASETS_ROOT", "REPO_ROOT", "TDDFA_ROOT", "TMP_ROOT", "SHARE_PY_ROOT", "SHARE_MODELS_ROOT"]
