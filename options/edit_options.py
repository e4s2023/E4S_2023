...
class EditOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--save_dir', default="/apdcephfs/share_1290939/zhianliu/running_results/our_editing/work_dirs/exp_recon_StyleGANWithMask_wNorm/EditResults", type=str, help='Path to save dir')  
        ...
        # ================= 编辑 相关 =========================
		self.parser.add_argument('--swap_comp', required=True, type=str, help='Which component to swap')
